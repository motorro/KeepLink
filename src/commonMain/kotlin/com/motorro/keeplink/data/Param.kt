 ...
 * @param value Param value
 */
internal infix fun String.of(value: String) = Param(this, value)
 ...
 */
internal fun Map<String, String>.toParams(): Array<Param> = entries.map(::Param).toTypedArray()
 ...
 */
internal fun Array<Param>.toMap(): Map<String, String> = associate { it.name to it.value }
 ...
 */
internal fun Array<Param>.getValue(name: String): String? = firstOrNull{ name == it.name }?.value