 ...
 */
internal actual fun String.toComponents(): UriComponents = with(URI(this)) {
    UriComponents(
        scheme = scheme ?: "",
 ...
 * @return Built URI
 */
internal actual fun UriComponents.build(): String = host.splitCombinedHost().let { (jvmHost, jvmPort) ->
    URI(
        scheme,
        null,
        jvmHost,
